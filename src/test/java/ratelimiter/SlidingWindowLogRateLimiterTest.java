...
public class SlidingWindowLogRateLimiterTest {
    private final SlidingWindowLogRateLimiter rateLimiter = new SlidingWindowLogRateLimiter(5, 10);
    ...
    public void shouldAllowRequestWhenMultipleCustomerRequestsIntertwine() {
        ...
        assertTrue(rateLimiter.shouldAllowRequest(aCustomerId, 9));
        assertTrue(rateLimiter.shouldAllowRequest(anotherCustomerId, 9));
